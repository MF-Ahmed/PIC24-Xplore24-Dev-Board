...
extern unsigned char EVLVCMD[2], MVLVCMD[12];
...
extern unsigned char	VCPCStatus[TOTMIN], VCPPStatus[TOTMIN] ;
extern unsigned short  CSPPStatus[TOTMIN], CSPCStatus[TOTMIN] ;

extern unsigned char FFRATLReq, FFRSEReq, EHPSEReq, VCPSEReq ;
extern unsigned char CSPATLReq[TOTMIN], CSPATLMOD[TOTMIN];
...
extern char VAD_CT[TOTCAS], VSD_CT[TOTCAS];
extern char VCD_CT[TOTCAS], FIM_DL, CMD_CT, VPD_CT[TOTCAS], VSC_CT[TOTCAS];

// Valve Action Delays
extern char VAD_D1[TOTCAS], VAD_D2[TOTCAS], VAD_D3[TOTCAS], VAD_D4[TOTCAS];

extern unsigned char V_EVPDM[2], V_EVPDS[2], ATLBMP[2];
extern unsigned char ILCBMP[2], VADBMP[2], V_MVPDM[TOTCAS], V_MVPDS[TOTCAS];
extern unsigned char VLV_SM[2], V_EMask[2], V_MMask[TOTMIN], BYPBMP[2];
extern unsigned char ILCMOD[TOTCAS], ATLMOD[TOTCAS];
extern unsigned char CCDCSTS, CCDPSTS;
 
extern int F_ValCmdReq, F_DR80AfterVCmd,F_AutLine, F_CCA, F_CCD;
extern int F_VCDVSD[TOTCAS], V_MCFGNo[TOTMIN];
extern unsigned char BYPBIT[TOTMIN];
extern unsigned char MinCFG[6], MainCFG[18], EGROUP[3];
...
extern int gethq() ;
extern int getpq() ;
extern int ProcessECrdSBox() ;
extern void GetEData() ;
extern void ProcMsECsPccData() ;
extern void ProcAnaData() ;
extern void ProcessValves(void) ;
extern void IniVar(void) ;
